...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_gamesubmission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.CoinGame'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('submitted', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'main', ['GameSubmission'])


    def backwards(self, orm):
        # Deleting model 'GameSubmission'
        db.delete_table(u'main_gamesubmission')
    ...
    models = {
        ...
        u'main.coingame': {
            'Meta': {'object_name': 'CoinGame'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'main.gamesubmission': {
            'Meta': {'object_name': 'GameSubmission'},
            'game': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.CoinGame']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
