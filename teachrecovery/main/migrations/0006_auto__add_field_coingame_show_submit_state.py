...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CoinGame.show_submit_state'
        db.add_column(u'main_coingame', 'show_submit_state',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CoinGame.show_submit_state'
        db.delete_column(u'main_coingame', 'show_submit_state')
