...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RandomQuizSection'
        db.create_table(u'quizblock_random_randomquizsection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('section', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pagetree.Section'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('quiz_current', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'quizblock_random', ['RandomQuizSection'])

        # Adding field 'QuestionUserLock.random_quiz'
        db.add_column(u'quizblock_random_questionuserlock', 'random_quiz',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quizblock_random.RandomQuizSection'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'RandomQuizSection'
        db.delete_table(u'quizblock_random_randomquizsection')

        # Deleting field 'QuestionUserLock.random_quiz'
        db.delete_column(u'quizblock_random_questionuserlock', 'random_quiz_id')
    ...
    models = {
        ...
        u'quizblock_random.questionuserlock': {
            ...
            'random_quiz': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['quizblock_random.RandomQuizSection']", 'null': 'True', 'blank': 'True'}),
        ...
        u'quizblock_random.randomquizsection': {
            'Meta': {'object_name': 'RandomQuizSection'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'quiz_current': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
