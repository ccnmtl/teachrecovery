...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuizRandom.quiz_type'
        db.add_column(u'quizblock_random_quizrandom', 'quiz_type',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuizRandom.quiz_type'
        db.delete_column(u'quizblock_random_quizrandom', 'quiz_type')
