...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionUserLock.question_used'
        db.add_column(u'quizblock_random_questionuserlock', 'question_used',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionUserLock.question_used'
        db.delete_column(u'quizblock_random_questionuserlock', 'question_used')
