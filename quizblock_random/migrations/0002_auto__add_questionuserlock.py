...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionUserLock'
        db.create_table(u'quizblock_random_questionuserlock', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quiz', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quizblock_random.QuizRandom'])),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quizblock.Question'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'quizblock_random', ['QuestionUserLock'])


    def backwards(self, orm):
        # Deleting model 'QuestionUserLock'
        db.delete_table(u'quizblock_random_questionuserlock')
